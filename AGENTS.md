...
- **Images:** endpoint uses **`get_image_model`** (not chat model); [`image_utils.py`](plugin/modules/writer/image_utils.py), [`image_tools.py`](plugin/modules/writer/image_tools.py); [docs/image-generation.md](docs/image-generation.md).
