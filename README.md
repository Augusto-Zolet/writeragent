...
- **New Calc Formula**: Use `=PYTHON("result = 3 ** 8")` or pass a range: `=PYTHON("result = sum(data)", A1:A10)` (2D blocks: see [data handoff](docs/enabling_numpy_in_libreoffice.md#10-technical-spec-data-handoff-spreadsheet--python--implemented)).
