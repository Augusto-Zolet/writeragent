...
def test_calc_sheet_filter_apply_get_clear(ctx, doc):
    ...
    res_get = _execute_calc_tool(doc, ctx, "get_sheet_filter", {"range_name": "G40:I43"})
    ...
    res_get_or = _execute_calc_tool(doc, ctx, "get_sheet_filter", {"range_name": "G40:I43"})
    ...
    res_clear = _execute_calc_tool(doc, ctx, "clear_sheet_filter", {"range_name": "G40:I43", "contains_header": True})
    assert res_clear.get("status") == "ok", f"clear_sheet_filter failed: {res_clear}"

    res_get2 = _execute_calc_tool(doc, ctx, "get_sheet_filter", {"range_name": "G40:I43"})
