...
from plugin.framework.constants import DEFAULT_EMBEDDING_MODEL
...
def test_knn_search_happy_path(ctx):
    ...
    with patch("plugin.framework.client.embeddings_service.run_code_in_user_venv", return_value={"status": "ok", "result": worker_payload}):
