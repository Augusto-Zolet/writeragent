...
from plugin.modules.writer.locale.linguistic_index import _DocIndex, IndexService
...
def test_index_service_search_boolean_near_integration(mock_services):
    ...
    with patch('plugin.modules.writer.locale.linguistic_index.IndexService._get_stemmer', return_value=mock_stemmer):
